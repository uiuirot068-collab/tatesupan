...
// comfortably judge character rhythm, indent, and line spacing. Raised to
// roughly 2.5x that (~10x actual physical size) — a pure display constant,
...
export const DEFAULT_SCALE_MULTIPLIER = 10;
