 ...
 * Human visual QA selected the midpoint between no compensation (too far)
 * and 0.1em compensation (too close): move the annotation lane 0.05 body-em
 * toward its parent. This retains a positive measured ink gap in all three
 * cases while targeting a 0.70em lane-center distance.
 *
 ...
 */
export const RUBY_PARENT_OPTICAL_INSET_EM = 0.05;
