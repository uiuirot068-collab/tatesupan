...
> The canonical TateSpun project is `rgvqquuthovqjqfogfra`. Keep the Function,
> secret, and cron in that project; the abandoned cross-project migration files
> are historical records and must not be executed.
